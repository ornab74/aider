---
name: mcp
description: Use Model Context Protocol servers with schema minimization and explicit trust boundaries.
...
# Context control
Summarize tool descriptions and retain only required fields. Prefer one capability-specific server over exposing every connected server.
